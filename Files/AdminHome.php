        ...
        <div class="container d-flex align-items-center justify-content-lg-between">
            ...
            <div>
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><button class="dropdown-item" type="button" onClick="window.location='profile_view.php';">View Profile</button></li>
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
                <div class="col-xl-6 col-lg-8">
                    <h1>Welcome Admin- <span> <?php echo strtoupper($teacher['first name']); ?> </span></h1>
                    <h3 style="color:aliceblue;"> <?php echo $teacher['admin_id']; ?></h3>
                </div>
            </div>

            <div class="row gy-4 mt-5 justify-content-center" id="ss" data-aos="zoom-in" data-aos-delay="250">
                <a href="Timetable/addtimetable.php">
                    <div class="col-xl-2 col-md-4">
                        <div class="icon-box">
                            <img src="assets/img/timetable.png" style="height: 50px;">
                            <h3 style="color: white;">Make SCHEDULE</h3>
                        </div>
                </a>
            </div>

            <div class="col-xl-2 col-md-4">
                <a href="admin/admin_signup_approv.php">
                    <div class="icon-box">
                        <img src="assets/img/notes.png" style="height: 50px; width: 50px;">
                        <h3 style="color: white;">Approve Signup</h3>
                    </div>
                </a>
            </div>

            <div class="col-xl-2 col-md-4">
                <a href="admin/admin_course_entry.php">
                    <div class="icon-box">
                        <img src="assets/img/attendance.png" style="height: 60px;">
                        <h3 style="color: white;">Create Course</h3>
                    </div>
                </a>
            </div>
        </div>
